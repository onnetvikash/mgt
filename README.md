...
Also, we have developed the <a href="https://github.com/onnetvikash/mgt" target="_blank">Code Migration Toolkit</a>, which will help to port extensions and your custom code to Magento 2, significantly reducing your porting efforts.
...
3.  Enter the following commands:
        ...
        composer config repositories.data-migration-tool git https://github.com/onnetvikash/mgt
